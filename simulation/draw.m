function draw(robot, map)
    ...
    robot.goal
    circle = int32([robot.pose(2) robot.pose(1) robot.robot_size; robot.goal(2) robot.goal(1) robot.robot_size; robot.frontier_point(2) robot.frontier_point(1) robot.robot_size*2]);
    new_image = step(shapeInserter, rgb_img, circle);
    ...
    figure(1)
    subplot(1,1,1), imshow(new_image)
